...
class SimServer:
    ...
    def __init__(
        ...
        if not file_path.endswith('_1000.json'):
            # load goal from file
            load_path = './data/webshop/preloaded1M_1kgoals.json'
            if human_goals:
                load_path = './data/webshop/preloaded1M_1kgoals_human.json'
            try:
                ...
                with open(load_path, 'w') as f:
                    json.dump(self.goals[:1000], f, indent=4)
        else:
