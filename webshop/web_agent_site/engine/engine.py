...
all_products, product_item_dict, product_prices, attribute_to_asins = None, None, None, None
def load_products(filepath, num_products=None, human_goals=True):
    ...
    # if num_products is None and os.path.exists('./data/webshop/preloaded_1Mproducts.json'):
    #     with open('./data/webshop/preloaded_1Mproducts.json') as f:
    #         preloaded_1Mproducts = json.load(f)
    #     all_products = preloaded_1Mproducts['all_products']
    #     product_item_dict = preloaded_1Mproducts['product_item_dict']
    #     product_prices = preloaded_1Mproducts['product_prices']
    #     attribute_to_asins = preloaded_1Mproducts['attribute_to_asins']
    #     return all_products, product_item_dict, product_prices, attribute_to_asins
    ...
    #     preloaded_1Mproducts = {
    #         'all_products': all_products,
    #         'product_item_dict': product_item_dict,
    #         'product_prices': product_prices,
    #         'attribute_to_asins': attribute_to_asins,
    #     }
    #     with open('./data/webshop/preloaded_1Mproducts.json', 'w') as f:
    #         json.dump(preloaded_1Mproducts, f)
